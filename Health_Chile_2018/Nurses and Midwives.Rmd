...
Health_Nur %>%
  ...
  labs(title = paste("Nurses and Midwives every 1,000 People\n", "by Country"), 
  ...
  geom_text(aes(label = Health_Nur$`Nursesandmidwivesper1,000people`), hjust = -.4, nudge_x = 0, color = "gray46", size = 3.1) +
